...
create table "todo" ("id" serial primary key, "text" text not null, "completed" boolean not null default false, "label" text not null, "status" text not null, "priority" text not null, "organization_id" text not null references "organization" ("id") on delete cascade, "created_at" timestamp not null default now(), "updated_at" timestamp not null default now());
